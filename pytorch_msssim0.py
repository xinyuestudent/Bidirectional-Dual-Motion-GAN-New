...
def ssim(X, Y, win_size=7, win_sigma=10, win=None, data_range=1, size_average=True, full=False):
...
def ms_ssim(X, Y, win_size=7, win_sigma=10, win=None, data_range=1, size_average=True, full=False, weights=None):
    if len(X.shape) != 4:
        raise ValueError('Input images must 4-d tensor.')
